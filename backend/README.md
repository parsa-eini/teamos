...
├── modules/         Business modules (auth, users, organizations, teams, projects, tasks, goals, checkins, dashboard, ...)
└── tests/           Test suite
...
`team_memberships`, `projects`, `tasks`, `goals`, and `checkins` tables. After changing models,
generate a revision and apply it with `alembic upgrade head`.

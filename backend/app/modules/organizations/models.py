...
class OrganizationMembership(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            ...
            name="ck_organization_memberships_reports_to_not_self",
        ),
    )
    ...
    # The person this member reports to. Null for the top of the tree.
    reports_to_user_id: Mapped[UUID | None] = mapped_column(

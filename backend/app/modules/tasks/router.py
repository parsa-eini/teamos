...
@router.get(
    ...
    description=(
        ...
        "Filter with status, priority, assignee_id, and project_id. The assignee_id filter "
        "matches tasks that include that person among their assignees."
    ),
...
@router.post(
    ...
    summary="Create task",
    description=(
        "Create a task on a project in the current organization. Every assignee must belong "

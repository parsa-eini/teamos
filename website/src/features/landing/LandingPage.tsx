...
const FEATURES = [
  ...
  {
    title: "Meetings",
    body: "Run check-ins, one-on-ones, and performance reviews through one draft, submit, and review loop.",
  },
  {
    title: "Feedback",
    body: "Record positive and negative notes about colleagues, visible to their management line.",
  },
  {
      ...
      <main className="flex-1">
        <section className="bg-slate-900 text-white">
          <div className="mx-auto max-w-6xl px-4 py-20">
            ...
            <p className="mt-5 max-w-2xl text-lg text-slate-300">
              ...
              projects, tasks, goals, meetings, feedback, and a manager dashboard.
            </p>
        ...
        <section className="mx-auto max-w-6xl px-4 py-16">
          ...
          <p className="mt-3 max-w-3xl text-slate-600">
            ...
            needs a conversation. That context is scattered, so attention arrives late.
          </p>
        </section>
        ...
        <section className="bg-slate-50">
          <div className="mx-auto max-w-6xl px-4 py-16">
            ...
            <p className="mt-3 max-w-3xl text-slate-600">
              ...
              set up a team, assign work, record goals and meetings, and open the dashboard.
            </p>
          </div>
        </section>
